...
var OGVDecoderVideoAV1SIMDMTW = (function() {
...
var Module = typeof OGVDecoderVideoAV1SIMDMTW !== "undefined" ? OGVDecoderVideoAV1SIMDMTW : {};
...
var STATIC_BASE = 1024, STACK_BASE = 5621856, STACKTOP = STACK_BASE, STACK_MAX = 378976, DYNAMIC_BASE = 5621856, DYNAMICTOP_PTR = 378048;
...
var wasmBinaryFile = "ogv-decoder-video-av1-simd-mt-wasm.wasm";
...
var __main_thread_futex_wait_address = 378960;
...
var PThread = {
 ...
 initMainThreadBlock: function() {
  ...
  PThread.mainThreadBlock = 378208;
 ...
 allocateUnusedWorker: function() {
  var pthreadMainJs = locateFile("ogv-decoder-video-av1-simd-mt-wasm.worker.js");
...
function _ogvjs_callback_async_complete(ret, cpuTime) {
...
function _ogvjs_callback_frame(bufferY, strideY, bufferCb, strideCb, bufferCr, strideCr, width, height, chromaWidth, chromaHeight, picWidth, picHeight, picX, picY, displayWidth, displayHeight) {
 ...
 var isOriginal = picWidth === format["cropWidth"] && picHeight === format["cropHeight"];
 if (isOriginal) {
  displayWidth = format["displayWidth"];
  displayHeight = format["displayHeight"];
 }
 var recycled = Module["recycledFrames"], frame, lenY = height * strideY, lenCb = chromaHeight * strideCb, lenCr = chromaHeight * strideCr;
 while (recycled.length > 0) {
  var next = recycled.shift(), format = next["format"];
  if (format["width"] === width && format["height"] === height && format["chromaWidth"] === chromaWidth && format["chromaHeight"] === chromaHeight && format["cropLeft"] === picX && format["cropTop"] === picY && format["cropWidth"] === picWidth && format["cropHeight"] === picHeight && format["displayWidth"] === displayWidth && format["displayHeight"] === displayHeight && next["y"]["bytes"].length === lenY && next["u"]["bytes"].length === lenCb && next["v"]["bytes"].length === lenCr) {
   frame = next;
   break;
  }
 }
...
var asmLibraryArg = {
 ...
 "ogvjs_callback_async_complete": _ogvjs_callback_async_complete,
 "ogvjs_callback_frame": _ogvjs_callback_frame,
...
var _ogv_video_decoder_init = Module["_ogv_video_decoder_init"] = function() {
 return (_ogv_video_decoder_init = Module["_ogv_video_decoder_init"] = Module["asm"]["ogv_video_decoder_init"]).apply(null, arguments);
};
...
var _ogv_video_decoder_async = Module["_ogv_video_decoder_async"] = function() {
 return (_ogv_video_decoder_async = Module["_ogv_video_decoder_async"] = Module["asm"]["ogv_video_decoder_async"]).apply(null, arguments);
};

var _ogv_video_decoder_destroy = Module["_ogv_video_decoder_destroy"] = function() {
 return (_ogv_video_decoder_destroy = Module["_ogv_video_decoder_destroy"] = Module["asm"]["ogv_video_decoder_destroy"]).apply(null, arguments);
};

var _ogv_video_decoder_process_header = Module["_ogv_video_decoder_process_header"] = function() {
 return (_ogv_video_decoder_process_header = Module["_ogv_video_decoder_process_header"] = Module["asm"]["ogv_video_decoder_process_header"]).apply(null, arguments);
};

var _ogv_video_decoder_process_frame = Module["_ogv_video_decoder_process_frame"] = function() {
 return (_ogv_video_decoder_process_frame = Module["_ogv_video_decoder_process_frame"] = Module["asm"]["ogv_video_decoder_process_frame"]).apply(null, arguments);
};
