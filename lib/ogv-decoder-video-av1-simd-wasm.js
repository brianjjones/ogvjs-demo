...
var Module = typeof OGVDecoderVideoAV1SIMDW !== 'undefined' ? OGVDecoderVideoAV1SIMDW : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ogv_video_decoder_init')) {
        Object.defineProperty(Module['ready'], '_ogv_video_decoder_init', { configurable: true, get: function() { abort('You are getting _ogv_video_decoder_init on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ogv_video_decoder_init', { configurable: true, set: function() { abort('You are setting _ogv_video_decoder_init on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ogv_video_decoder_async')) {
        Object.defineProperty(Module['ready'], '_ogv_video_decoder_async', { configurable: true, get: function() { abort('You are getting _ogv_video_decoder_async on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ogv_video_decoder_async', { configurable: true, set: function() { abort('You are setting _ogv_video_decoder_async on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ogv_video_decoder_process_header')) {
        Object.defineProperty(Module['ready'], '_ogv_video_decoder_process_header', { configurable: true, get: function() { abort('You are getting _ogv_video_decoder_process_header on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ogv_video_decoder_process_header', { configurable: true, set: function() { abort('You are setting _ogv_video_decoder_process_header on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ogv_video_decoder_process_frame')) {
        Object.defineProperty(Module['ready'], '_ogv_video_decoder_process_frame', { configurable: true, get: function() { abort('You are getting _ogv_video_decoder_process_frame on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ogv_video_decoder_process_frame', { configurable: true, set: function() { abort('You are setting _ogv_video_decoder_process_frame on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_ogv_video_decoder_destroy')) {
        Object.defineProperty(Module['ready'], '_ogv_video_decoder_destroy', { configurable: true, get: function() { abort('You are getting _ogv_video_decoder_destroy on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_ogv_video_decoder_destroy', { configurable: true, set: function() { abort('You are setting _ogv_video_decoder_destroy on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 376800,
    DYNAMIC_BASE = 5619680,
    DYNAMICTOP_PTR = 376640;
...
var wasmBinaryFile = 'ogv-decoder-video-av1-simd-wasm.wasm';
...
// {{PRE_LIBRARY}}
  ...
  function _ogvjs_callback_frame(bufferY, strideY,
  	                               bufferCb, strideCb,
  	                               bufferCr, strideCr,
  	                               width, height,
...
var asmGlobalArg = {};
var asmLibraryArg = { "__handle_stack_overflow": ___handle_stack_overflow, "abort": _abort, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "fd_close": _fd_close, "fd_seek": _fd_seek, "fd_write": _fd_write, "memory": wasmMemory, "ogvjs_callback_frame": _ogvjs_callback_frame, "pthread_attr_destroy": _pthread_attr_destroy, "pthread_attr_init": _pthread_attr_init, "pthread_attr_setstacksize": _pthread_attr_setstacksize, "pthread_create": _pthread_create, "pthread_join": _pthread_join, "setTempRet0": _setTempRet0, "table": wasmTable };
var asm = createWasm();
Module["asm"] = asm;
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var _ogv_video_decoder_init = Module["_ogv_video_decoder_init"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["ogv_video_decoder_init"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _ogv_video_decoder_async = Module["_ogv_video_decoder_async"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["ogv_video_decoder_async"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _ogv_video_decoder_destroy = Module["_ogv_video_decoder_destroy"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["ogv_video_decoder_destroy"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _ogv_video_decoder_process_header = Module["_ogv_video_decoder_process_header"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["ogv_video_decoder_process_header"].apply(null, arguments)
};

/** @type {function(...*):?} */
var _ogv_video_decoder_process_frame = Module["_ogv_video_decoder_process_frame"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["ogv_video_decoder_process_frame"].apply(null, arguments)
};
